<p align="center">
  ...
  <b>READMEや<a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">CyberDesk UI</a>、 <a href="https://github.com/rustdesk/doc.cyberdesk.app">CyberDesk Doc</a>の翻訳者を歓迎します！</b>
</p>
...
Rustで書かれた、設定不要ですぐに使えるリモートデスクトップソフトウェアです。自分のデータを完全にコントロールでき、セキュリティの心配もありません。私たちのランデブー/リレーサーバを使うことも、[自分でサーバーをセットアップする](https://cyberdesk.app/server) ことも、 [自分でランデブー/リレーサーバを作成する](https://github.com/rustdesk/rustdesk-server-demo)こともできます。
...
## [ビルド](https://cyberdesk.app/docs/en/dev/build/)
