...
<p align="center">
  ...
  <b>Chúng tôi rất hoan nghênh sự hỗ trợ của bạn trong việc dịch trang README, trang giao diện người dùng của CyberDesk - <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">CyberDesk UI</a> và trang tài liệu của CyberDesk - <a href="https://github.com/rustdesk/doc.cyberdesk.app">CyberDesk Doc</a> sang Tiếng Việt</b>
</p>
...
CyberDesk là một phần mềm điểu khiển máy tính từ xa mã nguồn mở, được viết bằng Rust. Nó hoạt động ngay sau khi cài đặt, không yêu cầu cấu hình phức tạp. Bạn có toàn quyền kiểm soát với dữ liệu của mình mà không cần phải lo lắng về vấn đề bảo mật. Bạn có thể sử dụng máy chủ rendezvous/relay của chúng tôi hoặc [tự cài đặt máy chủ của riêng mình](https://cyberdesk.app/server) hay thậm chí [tự tạo máy chủ rendezvous/relay cho riêng bạn](https://github.com/rustdesk/rustdesk-server-demo).
...
## [Build](https://cyberdesk.app/docs/en/dev/build/)
