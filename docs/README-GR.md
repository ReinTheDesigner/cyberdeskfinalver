<p align="center">
  ...
  <b>Χρειαζόμαστε τη βοήθειά σας για να μεταφράσουμε αυτό το αρχείο README, το <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">CyberDesk UI</a> και το <a href="https://github.com/rustdesk/doc.cyberdesk.app">Doc</a> στη μητρική σας γλώσσα</b>
</p>
