<p align="center">
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">a CyberDesk UI-t</a> és a <a href="https://github.com/rustdesk/doc.cyberdesk.app">Dokumentációt</a> az anyanyelvedre</b>
</p>
...
A CyberDesk egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a CyberDesk punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://cyberdesk.app/server), vagy akár [írhatsz is egyet](https://github.com/rustdesk/rustdesk-server-demo).
...
## [Építés](https://cyberdesk.app/docs/hu/dev/build/)
